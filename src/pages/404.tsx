...
function Page() {
  return (
    <main className="content flex flex-1 flex-col items-center justify-center py-12 text-center md:py-16 lg:py-20">
      <h1 className="mb-3 text-3xl font-extrabold text-neutral-700 dark:text-zinc-100 sm:mb-4 sm:text-4xl">
        Oops
      </h1>
      <p className="mb-6 text-lg text-neutral-700 dark:text-zinc-300 sm:text-xl">
